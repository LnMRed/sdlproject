...
class Renderer;
void initEntity(Entity* entity, Renderer* renderer, float Xpos, float Ypos, int width, int height, Shape shape, SDL_Color color, int size, bool isHandOrFoot, bool generateNodes = true);
